...
function Register() {
    ...
    const submitHandler=async(e)=>{
        try{
            ...
            const Register=await Axios.post("http://localhost:3000/users/register",newUser);
    ...
    return (
        ...
        <form className="form" onSubmit={submitHandler}>
            ...
            <input  className="input" type="password" onChange={(e)=> setPasswordCheck(e.target.value)} /><br></br>
            <label>Name</label>
            <input className="input" type="text" onChange={(e)=> setDisplayName(e.target.value)}/><br></br>
